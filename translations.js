...
export const translations = {
    ...
    turkish: {
        ...
        mockData: [
            ...
            galician: {
                appTitle: "Buscador de Citas de Literatura Espacial",
                appSubtitle: "Pega un parágrafo e obtén citas verificadas ao instante.",
                textareaPlaceholder: "Introduce aquí o teu parágrafo sobre investigación espacial, microgravidade ou enxeñaría aeroespacial...",
                btnGenerate: "Xerar Citas",
                btnClear: "Limpar",
                btnCopyAll: "Copiar Todo",
                btnExportPdf: "Exportar Bibliografía PDF",
                btnAddToProject: "Engadir ao Proxecto",
                selectProject: "Seleccionar Proxecto...",
                btnNewProject: "+ Novo",
                resultsHeading: "Citas",
                annotatedHeading: "Parágrafo Anotado",
                footerText1: "Construído con Antigravity 🚀",
                footerText2: "Deseño Accesible Espacial • WCAG 2.2 AA",
                filterBiotech: "Só Biotecnoloxía Espacial",
                formatLabel: "Formato:",
                signIn: "Iniciar sesión con Google",
                viewSource: "Ver fonte ⭧",
                mockData: [
                    {
                        ...
                        authors: "Smith, J., Roberts, L.",
                        year: 2023,
                        title: "Efectos da microgravidade prolongada na densidade ósea en operacións LEO.",
                        journal: "Revista de Saúde Espacial",
                        volume: "15(4)",
                        pages: "45-60",
                        summary: "Este estudo detalla a rápida perda de masa ósea en astronautas e avalía as contramedidas utilizadas a bordo da ISS.",
                        bullets: [
                            { category: "Microgravidade", explanation: "Analiza cambios fisiolóxicos en gravidade cero." },
                            { category: "Contramedidas", explanation: "Propón novos protocolos de exercicio." }
                        ],
                        url: "https://example.com/paper1",
                        isBiotech: true
                    },
                    {
                        ...
                        authors: "Chen, X., Williams, D.",
                        year: 2024,
                        title: "Sistemas de propulsión de próxima xeración para tránsito no espazo profundo.",
                        journal: "Revisión de Enxeñaría Aeroespacial",
                        volume: "8(2)",
                        pages: "112-130",
                        summary: "Revisa o estado actual da tecnoloxía de propulsores iónicos e a súa aplicación para misións a Marte.",
                        bullets: [
                            { category: "Propulsión", explanation: "Examina as ganancias de impulso específico." },
                            { category: "Espazo Profundo", explanation: "Aplicabilidade para misións estendidas máis aló da LEO." }
                        ],
                        url: "https://example.com/paper2",
                        isBiotech: false
                    }
            ...
            martinique_creole: {
                appTitle: "Chècheur Sitasion Litérati Lèspas",
                appSubtitle: "Kolé an paragraf épi jwenn sitasion verifyé menm lè a.",
                textareaPlaceholder: "Matjé paragraf anlè rechèch lèspas, mikrogravité, oben enjényéri aéwospasial isi a...",
                btnGenerate: "Jénéré Sitasion",
                btnClear: "Éfasé",
                btnCopyAll: "Kopié Tout",
                btnExportPdf: "Èspòté Bibliyografi PDF",
                btnAddToProject: "Ajouté adan Projé a",
                selectProject: "Chwazi Projé...",
                btnNewProject: "+ Nouvo",
                resultsHeading: "Sitasion",
                annotatedHeading: "Paragraf épi nòt",
                footerText1: "Fè épi Antigravity 🚀",
                footerText2: "Dizayn Aksésib pou Lèspas • WCAG 2.2 AA",
                filterBiotech: "Biyotèk Lèspas Sèlman",
                formatLabel: "Fòma:",
                signIn: "Konekté épi Google",
                viewSource: "Wè sours la ⭧",
                mockData: [
                    {
                        id: 'cit-1',
                        authors: "Smith, J., Roberts, L.",
                        year: 2023,
                        title: "Léfè mikrogravité prolomjé asou dansité zo an opérasyon LEO.",
                        journal: "Jounal Santé Lèspas",
                        volume: "15(4)",
                        pages: "45-60",
                        summary: "Létid-tala ka dékri pèd mas zo vitman lakay sé astronòt-la épi ka évalué sé mizi yo ka pran abò ISS-la.",
                        bullets: [
                            { category: "Mikrogravité", explanation: "Ka analizé chanjman fizyolojik an zéro-G." },
                            { category: "Mizi", explanation: "Ka propozé nouvo pwotokòl ègzèsis." }
                        ],
                        url: "https://example.com/paper1",
                        isBiotech: true
                    },
                    {
                        ...
                        authors: "Chen, X., Williams, D.",
                        year: 2024,
                        title: "Sistèm propilsyon jénérasyon ka vini pou transi an lèspas profon.",
                        journal: "Rëvi Enjényéri Aéwospasial",
                        volume: "8(2)",
                        pages: "112-130",
                        summary: "Ka gadé ki sitiyasyon tèknoloji propilsè iyon atjèlman épi kouman yo pé sèvi'y pou misyon asou Mars.",
                        bullets: [
                            { category: "Propilsyon", explanation: "Ka ègzaminé sé gen lenpilsyon èspésifik la." },
                            { category: "Lèspas Profon", explanation: "Aplikabilité pou misyon ki pli long apré LEO." }
                        ],
                        url: "https://example.com/paper2",
                        isBiotech: false
                    }
